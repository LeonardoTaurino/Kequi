...
def Numero_sostanze(entryget): #Save number of substaces and use it to build window data and matrix data
    ...
    try:
        ...
        error4 = Toplevel()
        error4.title("ERROR")
        lbl_error3 = Label(error4, text="Insert NUMBER of substances.").grid(row=0, column=0)
...
#------------------------------------------Finestra 1------------------------------------------
win = Tk()
win.title("Insert N substance")
lbl_win1=Label(win, text="Insert number of substance: ").grid(row=0, column=0)
